...
public class Aula06 extends Aula {
    ...
    private final Predicate<Estudante> matriculadas =
            e -> e.getCurso() != null;

    private final Predicate<Estudante> aprovadas =
            e -> e.getNota() >= 6;

    private final Predicate<Estudante> mulheresAprovadasCompostas =
            mulheresAprovadas.and(matriculadas).and(aprovadas);
    ...
    public List<Estudante> getEstudantesMulheresAprovadas() {
        ...
        return estudantes.stream()
                .filter(mulheresAprovadasCompostas)
                .toList();
    }
